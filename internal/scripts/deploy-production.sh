...
echo $SERVICE_NAME
echo $PROD_API_URL
URL=$PROD_API_URL SERVICE_NAME=$SERVICE_NAME  node ./internal/scripts/config_assign.js
URL=$PROD_API_URL SERVICE_NAME=$SERVICE_NAME node ./internal/scripts/secret_assign.js
